...
selectChangeHandler(event: any) {
  ...
  localStorage.setItem('font_text_icon',this.font_text_icon);
...
onKeytext(event: any) {
  ...
  localStorage.setItem('icon_text',this.icon_text);
}
onFileChanged(event) {
...
downloadImage(){
  ...
  localStorage.setItem('text_color',this.color1);
  localStorage.setItem('icon_color',this.color);
